...
![Comment from Frontier Airlines, source: https://faq.flyfrontier.com/help/do-you-offer-wi-fi-tv-movies-or-other-in-flight-entertainment](frontierwifi.png)
...
get_airlines_year <- function(airline, year) {
  airlines <- fread("airlines.csv") # Load the airlines using fread since it is faster than read.csv 
